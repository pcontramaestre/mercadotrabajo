                    ...
                    <div class="outer-box text-white">
                        <div class="dropdown dashboard-option">
                            ...
                            <ul
                                ...
                                <li>
                                    <a 
                                    x-bind:class="{ 'bg-blue-50 text-blue-600': currentPath === '/dashboard/company/dashboard' }"
                                    href="<?php echo SYSTEM_BASE_DIR ?>dashboard/company/dashboard" class="flex items-center gap-3 px-4 py-3 text-sm font-medium hover:bg-gray-50 rounded-md">
                                ...
                                <li>
                                    <a href="<?php echo SYSTEM_BASE_DIR ?>dashboard/company/myprofile"
                                        x-bind:class="{ 'bg-blue-50 text-blue-600': currentPath === '/dashboard/company/myprofile' }"
            ...
            <aside id="sidebar" class="sidebar w-64 bg-white h-screen md:h-auto border-r z-30 overflow-y-auto fixed">
                <div class="flex flex-col h-full">
                    <div class="flex-1 py-4">
                        <ul x-data="{ currentPath: window.location.pathname }" class="px-4 space-y-1">
                            <li>
                                <a 
                                x-bind:class="{ 'bg-blue-50 text-blue-600': currentPath === '/dashboard/company/dashboard' }"
                                href="<?php echo SYSTEM_BASE_DIR ?>dashboard/company/dashboard" class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-md">
                                    <i data-lucide="home" class="w-5 h-5"></i>
                                    Dashboard
                                </a>
                            </li>
                            <li>
                                <a 
                                x-bind:class="{ 'bg-blue-50 text-blue-600': currentPath === '/dashboard/company/myprofile' }"
                                href="<?php echo SYSTEM_BASE_DIR ?>dashboard/company/myprofile" class="flex items-center gap-3 px-4 py-3 text-sm font-medium rounded-md">
                                    <i data-lucide="user" class="w-5 h-5"></i>
                                    Company Profile!
                                </a>
                            </li>
