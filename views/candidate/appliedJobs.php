    ...
    <section class="user-dashboard max-w-6xl mx-auto">
        <div class="dashboard-outer p-4">
            <div class="upper-title-box">
                <h3 class="text-2xl font-bold text-gray-800">Mis trabajos aplicados</h3>
                <p class="text text-gray-500 mt-1">En esta sección puedes gestionar los trabajos a los que has postulado.</p>
            </div>
            <div class="grid">
                <div class="">
                    <div class="ls-widget">
                        <div class="tabs-box">
                            <div class="widget-title">
                                <h4>Mis trabajos aplicados</h4>
                            </div>
                            
                            <div class="widget-content hidden md:block">
                            ...
                            <div class="md:hidden">
                                <div class="table-outer">
                                    <div class="table-outer">
                                                <?php
                                                foreach ($dataUserJobsSave as $job) { ?>
                                                    <div class="job-block border border-gray-200 shadow-sm rounded-sm p-3 mb-4">
                                                        <div>
                                                            <div class="job-block">
                                                                <div class="">
                                                                    <div class="content">
                                                        ...
                                                        <div class="status text-center">
                                                            <?php 
                                                                echo $job['is_active'] ? '<span class="active text-green-500">Activo</span>' : '<span class="no-active text-red-500">No activo</span>';
                                                            ?>
                                                        </div>
                                                        <div>
                                                            <div class="option-box">
                                                                <ul class="option-list justify-center">
                                                                    <li>
                                                                        <a 
                                                                            class="flex flex-row items-center justify-center boton-view"
                                                                            data-text="View job" href="<?php echo $job['is_active'] ? SYSTEM_BASE_DIR.'searchjobs?job='.$job['id'] : '#'?>">
